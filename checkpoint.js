...
function pluck(array, propiedad) { 
  ...
  //var array = [{ propiedad: 'TV LCD', price: 100}, { name: 'Computadora', price: 500 }]

  var arraydeobjetos = array.map(function(elemento) {
...
function crearClasePersona() {
  ...
  class Persona {
    ...
    getFriends() {
      ...
      var arr = this.amigos.map(function(elemento){
    ...
    getHobbies() {
      ...
      // persona.getHobbies() // retorna ['correr', 'dormir', 'nadar']
       ...
       var array = this.hobbies.map(function(elemento){
       return elemento;
      })
      return array;  
    }
